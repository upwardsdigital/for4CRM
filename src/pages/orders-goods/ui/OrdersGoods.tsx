...
import styles from './OrdersGoods.module.sass';
  ...
  return (
    <div>
      <div className="page-header">
        <h1 className="page_title">Подготовка и передача товара </h1>
        ...
        <div className={styles.filter_items}>
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <div>
                <label htmlFor="date-range-picker" className={styles.filter_item_label}>
                  Дата офоромления доставки (передача курьеру)
                </label>
                <DateRangePicker
          ...
          <div className={styles.filter_content}>
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <div>
                <label htmlFor="date-range-picker" className={styles.filter_item_label}>
                  Дата оприбытия на транзитный склад
                </label>
                <DateRangePicker
                  onChange={handleDateChange}
                  className={styles.filter_item_calendar}
