...
import styles from './InnercategoriesPage.module.sass';
...
export const InnercategoriesPage = () => {
  ...
  const fetchData = async () => {
    try {
      const resp = await DepartmentService.getInnerCategories({
        ...data.pagination,
        ...data.filters,
      });
      if (resp.data) {
  ...
  return (
    <div className={clsx(styles.page, 'page')}>
      <div className="page-header">
        <h1 className="page_title">Внутренние категории</h1>
