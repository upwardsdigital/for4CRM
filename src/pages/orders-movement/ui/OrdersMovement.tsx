...
import styles from './OrdersMovement.module.sass';
  ...
  return (
    <div>
      <div className="page-header">
        <h1 className="page_title">Окончательная доставка покупателю</h1>
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <div>
                <label htmlFor="date-range-picker" className={styles.filter_item_label}>
                  Дата оформления доставки покупателю
                </label>
                <DateRangePicker
